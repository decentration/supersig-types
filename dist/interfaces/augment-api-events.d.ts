...
import type { FrameSupportTokensMiscBalanceStatus, FrameSupportWeightsDispatchInfo, PalletSupersigRole, SpFinalityGrandpaAppPublic, SpRuntimeDispatchError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        supersig: {
             ...
             **/
            CallExecutionAttempted: AugmentedEvent<ApiType, [AccountId32, u128, Result<Result<Null, SpRuntimeDispatchError>, SpRuntimeDispatchError>]>;
            /**
             * a Call has been removed [supersig, call_nonce]
             **/
            CallRemoved: AugmentedEvent<ApiType, [AccountId32, u128]>;
            /**
             * a Call has been submited [supersig, call_nonce, submiter]
             **/
            CallSubmitted: AugmentedEvent<ApiType, [AccountId32, u128, AccountId32]>;
            /**
             * a Call has been voted [supersig, call_nonce, voter]
             **/
            CallVoted: AugmentedEvent<ApiType, [AccountId32, u128, AccountId32]>;
            /**
             * the list of users added to the supersig [supersig, [(user, role)]]
             * Users that were already in the supersig wont appear
             **/
            MembersAdded: AugmentedEvent<ApiType, [AccountId32, Vec<ITuple<[AccountId32, PalletSupersigRole]>>]>;
            /**
             * the list of users removed from the supersig [supersig, removed_users]
             **/
            MembersRemoved: AugmentedEvent<ApiType, [AccountId32, Vec<AccountId32>]>;
            /**
             * Supersig has been created [supersig]
             **/
            SupersigCreated: AugmentedEvent<ApiType, [AccountId32]>;
            /**
             * a member leaved the supersig [supersig, member]
             **/
            SupersigLeaved: AugmentedEvent<ApiType, [AccountId32, AccountId32]>;
            /**
             * a supersig have been removed [supersig]
             **/
            SupersigRemoved: AugmentedEvent<ApiType, [AccountId32]>;
        };
        system: {
            /**
             * `:code` was updated.
