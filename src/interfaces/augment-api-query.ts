...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    supersig: {
      calls: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletSupersigPreimageCall>>, [u128, u128]>;
      members: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<PalletSupersigRole>, [u128, AccountId32]>;
      membersVotes: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: u128 | AnyNumber | Uint8Array, arg3: AccountId32 | string | Uint8Array) => Observable<bool>, [u128, u128, AccountId32]>;
      nonceCall: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<u128>, [u128]>;
      nonceSupersig: AugmentedQuery<ApiType, () => Observable<u128>, []>;
      totalDeposit: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<u128>, [u128]>;
      totalMembers: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<u32>, [u128]>;
      votes: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: u128 | AnyNumber | Uint8Array) => Observable<u32>, [u128, u128]>;
    };
    system: {
      /**
